function [NeuronParams,NA]=setMophology(ncell,ModelFun,stp)
...
NeuronParams.compartmentLength=NeuronParams.compartmentLength*10^-4;
NeuronParams.A=pi*NeuronParams.compartmentDiameterArr.*NeuronParams.compartmentLength;%*10 cm^2
NeuronParams.A(1)=pi*NeuronParams.compartmentDiameterArr(1).^2;%*10 cm^2
...
NeuronParams.Ra = 150.*repmat(NeuronParams.compartmentLength(:)',ncell,1)./(repmat(NeuronParams.compartmentDiameterArr(:)',ncell,1).^2/4*pi)/10^9 ;% /100000 Ω cm 
...
channelstype=[1];%[1];%:3[1:3];%21:3,10,10];
NeuronParams.compartmentDiameterArr=NeuronParams.compartmentDiameterArr/10^-4;
NeuronParams.compartmentLength=NeuronParams.compartmentLength/10^-4;
%%
